...
const SingleProduct = () => {
  ...
  const { id } = useParams();
  const theItem = phones.find((phone) => phone.id === Number(id));
  return (
    <>
        ...
        <div className='super_container'>
                          ...
                          >
                            <div className='custom_dropdown'>
                              <div className='custom_dropdown_list'>
                                ...
                                <ul className='ul-s custom_list clc'>
                                  <li className='li-s'>
          ...
          <div className='single_product'>
            <div className='product-image'>
              <img src={theItem.imgUrl} alt='' width='100%' />
            </div>
            <div
                  ...
                  <div className='product_description'>
                    <nav>
                      <ol className='breadcrumb'>
                        <li className='li-s' className='breadcrumb-item'>
                          <a href='#'>Home</a>
                        </li>
                        <li className='li-s' className='breadcrumb-item'>
                          <a href='#'>Products</a>
                        </li>
                        <li className='li-s' className='breadcrumb-item active'>
                          Accessories
                        </li>
                      </ol>
                    </nav>
                    <div className='product_name'>
                      {theItem.title} {theItem.info}
                    </div>
